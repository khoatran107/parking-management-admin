...
const handleSubmit = (e) => {
    ...
    return (
        ...
        <div className='bg-white p-3 rounded'>
            ...
            <button type='submit' className='btn btn-success w-100 rounded-0 mx-0'>Log in</button>
            <p className='m-0'>Don't have an accout? Create one!</p>
            <Link to = "/register" className='btn btn-secondary border w-100 rounded-0 text-decoration-none mx-0'>Create Account</Link>
            </form>
        </div>
        </div>
    );
